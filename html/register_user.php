        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Fiscalipro</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Módulos</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div data-i18n="Without menu">Módulo 1</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div data-i18n="Without navbar">Módulo 2</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div data-i18n="Container">Módulo 3</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div data-i18n="Fluid">Módulo 4</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="#" class="menu-link">
                    <div data-i18n="Blank">Módulo 5</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <!-- Tables -->
            <li class="menu-item">
              <a href="register_user.html" class="menu-link">
            ...
            <li class="menu-item">
              <a href="#" class="menu-link">
                ...
                <div data-i18n="Tables">Documentación</div>
              </a>
            </li>
        ...
        <div class="layout-page">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Usuario A</span>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">FiscaliPro /</span> Registrar Usuario</h4>
            ...
            <script>
              ...
              function agregarUsuario(nombre, apellidos, email, telefono, rol) {
                ...
                nuevaFila.innerHTML = `
                  ...
                  <td>${email}</td>
                  <td>${telefono}</td>
                  <td><span class="badge bg-label-primary">${rol}</span></td>
                  <td>
                    <div class="dropdown">
              ...
              document.getElementById('guardarUsuario').addEventListener('click', function() {
                ...
                if (nombre && apellidos && email && telefono && rol && password) {
                  // Agregar el usuario a la tabla (Interfaz de usuario)
                  agregarUsuario(nombre, apellidos, email, telefono, rol);
